...
[window, windowRect] = Screen('OpenWindow', screenNumber, grey); % Open a grey on screen window
[window2, windowRect2] = Screen('OpenWindow', max(screens), black); %turn on tablet screen
