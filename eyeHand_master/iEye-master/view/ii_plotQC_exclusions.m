function [fh] = ii_plotQC_exclusions(ii_trial,ii_cfg,which_excl,fig_visible, plot_which)
...
% plot_which added by Mrugank (05/11/2023)
...
if nargin < 5 || isempty(plot_which)
    plot_which = [1, 2];
end
